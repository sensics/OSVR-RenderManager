...
namespace renderkit {
    ...
    class RenderManagerOpenGLES20 : public RenderManager {
      public:
        virtual ~RenderManagerOpenGLES20();
      ...
      protected:
        ...
        bool addOpenGLES20Context(GLES20ContextParams p);
        bool removeOpenGLES20Contexts();
